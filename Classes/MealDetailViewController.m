...
- (void) getFetchedResultsController {
    ...
    NSEntityDescription *entity = [NSEntityDescription 
								   entityForName:@"Meal" inManagedObjectContext:managedObjectContext];
...
- (void)addButtonPressed {
	...
	[newMeal setValue:dateString forKey:@"title"];
	[newMeal setValue:@"Daily Meals" forKey:@"subtitle"];
	[newMeal setValue:today forKey:@"meal_date"];
