...
@synthesize contextKey, window, splitViewController, navigationController, rootViewController, contextController, detailViewController, popoverController;

#pragma mark -
#pragma mark Custom Methods

- (void)refreshDisplay {
	[contextController refreshTableView];
}
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Punch.sqlite"];
