/*********************************************************************
 File: MealDetailViewController.h
...
@interface MealDetailViewController : UIViewController <NSFetchedResultsControllerDelegate, SubstitutableDetailViewController> {
	// UI
