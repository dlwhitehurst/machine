/*********************************************************************
 File: ExerciseDetailViewController.h
...
@interface ExerciseDetailViewController : UIViewController <NSFetchedResultsControllerDelegate, SubstitutableDetailViewController> {
	// UI
